              ...
              {selectedRequest?.attachment_url && (
                <div className="border-t border-primary/10 pt-3">
                  ...
                  <div className="bg-white rounded-lg border border-primary/20 p-3">
                    {selectedRequest.attachment_url.match(/\.(jpg|jpeg|png|gif)$/i) ? (
                      ...
                      <div className="space-y-3">
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded transition-colors border border-gray-200"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-gray-500 truncate">{selectedRequest.attachment_url.split('/').pop()}</p>
                          </div>
                          <ExternalLink className="w-5 h-5 text-gray-400 flex-shrink-0" />
                        </a>
                        <div className="bg-amber-50 border border-amber-200 rounded p-2">
                          <p className="text-xs text-amber-800">
                            <strong>Note:</strong> If the document doesn't open, copy the URL and paste it in a new browser tab, or download it from your Cloudinary Media Library.
                          </p>
                        </div>
                      </div>
                    )}
