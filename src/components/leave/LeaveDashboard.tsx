  ...
  return (
    <DashboardLayout title="Leave Management">
      <div className="space-y-3 sm:space-y-4 lg:space-y-4">
        ...
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg border border-amber-200 p-4 sm:p-5 lg:p-6 shadow-sm">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
            <div>
              <h2 className="text-base sm:text-lg font-bold text-gray-900 mb-0.5">Leave Management</h2>
              <p className="text-xs text-amber-700">Track and manage your leave balance</p>
            </div>
            <button
              onClick={() => setIsApplyModalOpen(true)}
              className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-amber-600 text-white rounded-lg font-semibold text-xs sm:text-sm hover:bg-amber-700 transition-colors shadow-md hover:shadow-lg"
            >
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Overview of all leave types</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-4 gap-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700">Your leave applications</p>
              </div>
            </div>
            {approvedRequests > 0 && (
