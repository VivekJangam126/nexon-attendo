      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-amber-100 text-amber-700 rounded-full text-xs font-semibold mb-6 animate-fade-in-up">
                  <CheckCircle className="w-3.5 h-3.5" />
                  Modern Attendance Management
                </div>
                
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                  Streamline Your
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                  <button
                    onClick={() => navigate("/login")}
                    className="group px-8 py-4 bg-gradient-to-r from-amber-600 to-amber-500 text-white rounded-xl font-semibold text-base hover:from-amber-700 hover:to-amber-600 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                  >
                    Get Started
                  ...
                  <button
                    ...
                    className="px-8 py-4 bg-white text-gray-900 rounded-xl font-semibold text-base hover:bg-gray-50 transition-all duration-300 shadow-md hover:shadow-lg border border-gray-200"
                  >
                    Admin Portal
                  </button>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
                <div className="col-span-2 bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-center gap-4">
                    <div className="p-3 bg-blue-100 rounded-xl">
                      <Clock className="w-6 h-6 text-blue-600" />
                    </div>
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Real-time Tracking</h3>
                      <p className="text-sm text-gray-600">Monitor attendance instantly</p>
                    </div>
                  </div>
                </div>
                
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="p-3 bg-green-100 rounded-xl mb-3 w-fit">
                    <Users className="w-6 h-6 text-green-600" />
                  </div>
                  <h3 className="font-bold text-gray-900 mb-1 text-sm">Team Management</h3>
                  <p className="text-xs text-gray-600">Organize efficiently</p>
                </div>
                
                <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="p-3 bg-purple-100 rounded-xl mb-3 w-fit">
                    <Calendar className="w-6 h-6 text-purple-600" />
                  </div>
                  <h3 className="font-bold text-gray-900 mb-1 text-sm">Leave System</h3>
                  <p className="text-xs text-gray-600">Automated approvals</p>
                </div>
                
                <div className="col-span-2 bg-gradient-to-br from-amber-600 to-orange-500 rounded-2xl p-6 shadow-lg text-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-100">Insights & reports at your fingertips</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="px-6 py-12 sm:px-8 bg-white/50 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold text-gray-900 mb-3">Why Choose Nexus Attendo?</h3>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 animate-fade-in-up"
                  style={{ animationDelay: `${i * 0.1}s` }}
                >
                  <div className={`p-3 bg-${feature.color}-100 rounded-xl mb-4 w-fit`}>
        ...
        <section className="px-6 py-16 sm:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-amber-600 via-amber-500 to-orange-500 rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <button
                  onClick={() => navigate("/login")}
                  className="px-8 py-4 bg-white text-amber-600 rounded-xl font-bold text-base hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl inline-flex items-center gap-2"
                >
                  Start Now
