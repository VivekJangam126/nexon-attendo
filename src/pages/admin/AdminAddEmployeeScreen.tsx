      ...
      <div className="flex flex-col min-h-full pb-20 md:pb-0">
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-4 overflow-y-auto">
          <div className="max-w-2xl">
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-2.5 mb-4 flex gap-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-2 justify-end pt-1">
                ...
                <button 
                  ...
                  className="h-9 px-4 text-xs font-medium bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
